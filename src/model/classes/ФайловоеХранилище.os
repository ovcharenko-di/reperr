...
Процедура ИнициализироватьХранилище()
	...
	МассивФайлов.Добавить(ИмяФайлаЗарегистрированныеОшибки);
...
Процедура СохранитьФайлОтчета(ИдОтчетаОбОшибке, ФайлОтчета) Экспорт
	...
	ИмяФайлаОтчета = СтрШаблон("%1.zip", ИдОтчетаОбОшибке);
...
Процедура ЗаписатьИнформациюОбОшибке(Знач ИдОтчетаОбОшибке, ФайлОтчета) Экспорт
