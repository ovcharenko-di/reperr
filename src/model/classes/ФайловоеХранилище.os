...
Процедура СохранитьФайлОтчета(ИдОтчетаОбОшибке, ФайлОтчета) Экспорт
	...
	РаспаковатьАрхивВКаталог(ИдОтчетаОбОшибке, ФайлОтчета);
	ЗаписатьИнформациюОбОшибке(ИдОтчетаОбОшибке);
...
Процедура ЗаписатьИнформациюОбОшибке(Знач ИдОтчетаОбОшибке)
