...
Процедура ТестДолжен_ОбработатьУжеЗарегистрированнуюОшибкуБезИдЗадачи() Экспорт

	ЧтениеТекста = Новый ЧтениеТекста("getInfoDuplicateRequestWithoutIssueID.json", "utf-8");
	ТелоЗапросаТекст = ЧтениеТекста.Прочитать();
	ЧтениеТекста.Закрыть();
